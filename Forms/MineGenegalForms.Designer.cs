namespace Load_bank_files.Forms
{
    partial class MineGenegalForms
    {
        ...
        {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(MineGenegalForms));
			...
			this.гПБКЛДToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
			...
			this.обычныйФорматФайлаToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
			...
			// 
			this.loadSberbankToolStripMenuItem.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] {
            this.форматОднодневокToolStripMenuItem,
            this.внутреннийФорматБанкаToolStripMenuItem,
            this.обычныйФорматФайлаToolStripMenuItem});
			this.loadSberbankToolStripMenuItem.Name = "loadSberbankToolStripMenuItem";
			this.loadSberbankToolStripMenuItem.Size = new System.Drawing.Size(216, 22);
			this.loadSberbankToolStripMenuItem.Text = "Формат файла сбербанка";
			this.loadSberbankToolStripMenuItem.Click += new System.EventHandler(this.loadSberbankToolStripMenuItem_Click);
			// 
			// форматОднодневокToolStripMenuItem
			// 
			this.форматОднодневокToolStripMenuItem.Name = "форматОднодневокToolStripMenuItem";
			this.форматОднодневокToolStripMenuItem.Size = new System.Drawing.Size(221, 22);
			this.форматОднодневокToolStripMenuItem.Text = "Формат однодневок";
			this.форматОднодневокToolStripMenuItem.Click += new System.EventHandler(this.форматОднодневокToolStripMenuItem_Click);
			// 
			// внутреннийФорматБанкаToolStripMenuItem
			// 
			this.внутреннийФорматБанкаToolStripMenuItem.Name = "внутреннийФорматБанкаToolStripMenuItem";
			this.внутреннийФорматБанкаToolStripMenuItem.Size = new System.Drawing.Size(221, 22);
			this.внутреннийФорматБанкаToolStripMenuItem.Text = "Внутренний формат банка";
			this.внутреннийФорматБанкаToolStripMenuItem.Click += new System.EventHandler(this.внутреннийФорматБанкаToolStripMenuItem_Click);
			// 
			// обычныйФорматФайлаToolStripMenuItem
			// 
			this.обычныйФорматФайлаToolStripMenuItem.Name = "обычныйФорматФайлаToolStripMenuItem";
			this.обычныйФорматФайлаToolStripMenuItem.Size = new System.Drawing.Size(221, 22);
			this.обычныйФорматФайлаToolStripMenuItem.Text = "Основной формат файла";
			this.обычныйФорматФайлаToolStripMenuItem.Click += new System.EventHandler(this.обычныйФорматФайлаToolStripMenuItem_Click);
			// 
			// форматФайлаГПБToolStripMenuItem
			// 
			this.форматФайлаГПБToolStripMenuItem.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] {
            this.основнойФорматToolStripMenuItem,
            this.основнойФорматФайлаКЛДToolStripMenuItem});
			this.форматФайлаГПБToolStripMenuItem.Name = "форматФайлаГПБToolStripMenuItem";
			this.форматФайлаГПБToolStripMenuItem.Size = new System.Drawing.Size(216, 22);
			this.форматФайлаГПБToolStripMenuItem.Text = "Формат файла ГПБ";
			// 
			// основнойФорматToolStripMenuItem
			// 
			this.основнойФорматToolStripMenuItem.Name = "основнойФорматToolStripMenuItem";
			this.основнойФорматToolStripMenuItem.Size = new System.Drawing.Size(243, 22);
			this.основнойФорматToolStripMenuItem.Text = "Основной формат файла МСК";
			this.основнойФорматToolStripMenuItem.Click += new System.EventHandler(this.основнойФорматToolStripMenuItem_Click);
			// 
			// основнойФорматФайлаКЛДToolStripMenuItem
			// 
			this.основнойФорматФайлаКЛДToolStripMenuItem.Name = "основнойФорматФайлаКЛДToolStripMenuItem";
			this.основнойФорматФайлаКЛДToolStripMenuItem.Size = new System.Drawing.Size(243, 22);
			...
			this.Load += new System.EventHandler(this.MineGenegalForms_Load);
        ...
        private System.Windows.Forms.ToolStripMenuItem внутреннийФорматБанкаToolStripMenuItem;
        private System.Windows.Forms.ToolStripMenuItem обычныйФорматФайлаToolStripMenuItem;
        private System.Windows.Forms.ToolStripMenuItem работаСФайламиБанковToolStripMenuItem;
		private System.Windows.Forms.ToolStripMenuItem форматФайлаГПБToolStripMenuItem;
		private System.Windows.Forms.ToolStripMenuItem основнойФорматToolStripMenuItem;
